...
description: "Manage scheduled tasks, recurring workflows, and reminders. Use when: the user asks to be reminded of something, wants a recurring check or workflow, asks for something to happen on a schedule, says words like every, daily, weekly, monitor, remind, check regularly, keep an eye on. Also use on session start to restore crons from config.json."
---
