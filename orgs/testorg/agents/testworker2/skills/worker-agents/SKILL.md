...
```bash
bash $CTX_FRAMEWORK_ROOT/bus/log-event.sh action worker_spawned info \
...
```bash
# Log completion
bash $CTX_FRAMEWORK_ROOT/bus/log-event.sh action worker_completed info \
...
bash $CTX_FRAMEWORK_ROOT/bus/log-event.sh action worker_failed info \
