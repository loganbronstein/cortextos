...
<message text>
Reply using: bash $CTX_FRAMEWORK_ROOT/bus/send-telegram.sh <chat_id> "<your reply>"

=== AGENT MESSAGE from <agent> [msg_id: <id>] ===
<message text>
Reply using: bash $CTX_FRAMEWORK_ROOT/bus/send-message.sh <agent> normal '<your reply>' <msg_id>
```
