 ...
 * match what the Next.js dashboard at /Users/cortextos/cortextos/dashboard expects.
 *
...
test.describe('Agent config JSON format', () => {
  test('enabled-agents.json matches dashboard expectations', () => {
    ...
    const config = {
      boris: { enabled: true, org: 'lifeos', template: 'orchestrator', createdAt: '2026-03-01T10:00:00Z' },
      donna: { enabled: true, org: 'lifeos', template: 'agent', createdAt: '2026-03-05T08:30:00Z' },
      inactive: { enabled: false, org: 'lifeos', template: 'agent', createdAt: '2026-03-10T12:00:00Z' },
    };
