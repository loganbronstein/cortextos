---
name: onboarding
description: First boot onboarding protocol for the Analyst. Runs automatically on first boot. Can also be triggered manually with /onboarding if onboarding was interrupted or needs to be re-run.
---
