...
```json
{
  "name": "usage-check",
  "interval": "15m",
  "prompt": "Run cortextos bus check-usage-api and apply the rate limit protocol from plugins/cortextos-agent-skills/skills/rate-limit-management/SKILL.md based on current utilization."
}
```
